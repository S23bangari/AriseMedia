    ...
    <div className="pw-main">
      ...
      <div className="card-grid">
        ...
        <div className="video-box">
          ...
          <div className="name">
            <span className='text-2xl bg-transparent absolute bottom-24 right-14'>@MagnatesMedia</span>
            <div className="sub-view-text">
        ...
        <div className="video-box">
          ...
          <div className="name">
            <span className='text-2xl bg-transparent absolute bottom-24 right-20'>@TechnoGamerz</span>
        ...
        <div className="video-box">
          ...
          <div className="name">
            <span className='text-2xl bg-transparent absolute bottom-24 right-20'>@VisualVenture</span>
            <div className="sub-view-text">
        ...
        <div className="video-box">
          ...
          <div className="name">
            <span className='text-2xl bg-transparent absolute bottom-24 right-12'>@InternetAnarchist</span>
            <div className="sub-view-text">
